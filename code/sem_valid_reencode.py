...
from reencode import reencode_prog, prog_to_pc
...
def clean_forward(decoder, inp_seq, reencoding, h, bb_dims, input_dim, device, P):
    ...
    gru_out, h = decoder.gru(inp, h)

    cmd_out = decoder.cmd_net(gru_out)
